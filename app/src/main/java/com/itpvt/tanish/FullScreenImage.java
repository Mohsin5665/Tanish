...
import com.itpvt.tanish.Adapters.FUll_Image_Adapter_Pager;
import com.itpvt.tanish.Pojo.Full_Image_URL;
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i=0; i<axyz.length(); i ++)
                    {
                        ...
                        arrayList.add(new Full_Image_URL(data.getString("img")));
